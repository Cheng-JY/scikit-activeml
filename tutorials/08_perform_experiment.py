...
def save_in_csv():
    ...
    output_path=f'/mnt/stud/home/jcheng/scikit-activeml/tutorials/csv_4/{dataset_name}_{n_cycles}_new_csv.csv'
...
if __name__ == '__main__':
    ...
    exp = mlflow.get_experiment_by_name(name="Evaluation-Active-Learning-Params")
