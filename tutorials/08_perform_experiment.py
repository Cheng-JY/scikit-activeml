...
def save_in_csv():
    ...
    output_path=f'/mnt/stud/home/jcheng/scikit-activeml/tutorials/csv_3/{dataset_name}_{n_cycles}_new_csv.csv'
...
if __name__ == '__main__':
    ...
    exp = mlflow.get_experiment_by_name("Evaluation-Active-Learning-Params-Cifar100")
    experiment_id = mlflow.create_experiment(name="Evaluation-Active-Learning-Params-Cifar100") if exp is None else exp.experiment_id
    ...
    with (mlflow.start_run(experiment_id=experiment_id) as active_run):
        ...
        for c in tqdm(range(n_cycles), desc=f'{qs_name} for {dataset_name}'):
            ...
            metric_dict['accuracy'].append(score)
            metric_dict['time'].append(end - start)
